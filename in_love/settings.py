...
SECRET_KEY = 'django-insecure-*anw=$8*g_$91d(5elc6tdctw_$i5b-%4&e^9^o-gu%*!brw!('
...
ROOT_URLCONF = 'in_love.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'love/templates'], 
          'APP_DIRS': True, 
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'in_love.wsgi.application'
